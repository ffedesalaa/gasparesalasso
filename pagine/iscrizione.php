...
<head>
    ...
    <div class="contenitore_accesso">
         <form action="../file_php/esempio.php">
            ...
            <input type="text" placeholder="Inserisci Nome" name="email" id="email">
            <label for="password">Cognome</label>
            <input type="text" placeholder="Inserisci Cognome" name="password" id="password">
            ...
            <input type="text" placeholder="Conferma password" name="password" id="password">
